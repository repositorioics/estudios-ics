    ...
    <div class="main">
        ...
        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                ...
                <a href="<spring:url value="/cartas/ListadoCartaParticipant" htmlEscape="true "/>"><spring:message code="lbl.ento" /> <i class="fa fa-angle-right"></i></a>
                <a href="<spring:url value="/cartas/informacion" htmlEscape="true "/>"><spring:message code="lbl.letters.info" /></a>
            </li>
        </ol>
        <spring:url value="/reportes/downloadEntoInfo/" var="fileUrl"/>
                        ...
                        <div class="col-md-10">
                            <form autocomplete="off" id="search-participant-form" class="form-horizontal">
                                ...
                                <div class="form-group row">
                                    <label class="form-control-label col-md-3" for="fechaInicio"><spring:message code="lbl.ento.start.date" />:
                                    </label>
                                ...
                                <div class="form-group row">
                                    <label class="form-control-label col-md-3" for="fechaFin"><spring:message code="lbl.ento.end.date" />:
                                    </label>
                                    <div class="input-group col-md-6">
                                    <span class="input-group-addon">
                                        <i class="fa fa-calendar"></i>
