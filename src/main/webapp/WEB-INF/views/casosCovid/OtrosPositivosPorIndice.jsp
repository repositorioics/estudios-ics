    ...
    <div class="main">
        ...
        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                ...
                <i class="fa fa-angle-right"></i>
                <a href="<spring:url value="/super/covid/otrosPositivosCovid/{codigo}">
                         <spring:param name="codigo" value="${candidato.codigo}" />
                         </spring:url>"><spring:message code="others" /> <spring:message code="covid19.positives" />
                </a>
            </li>
        </ol>
        <div class="container-fluid">
            ...
            <spring:url value="/covid/saveOtrosPositivosTCovid" var="saveOtrosCandidateTCovidUrl"/>
            <c:set var="successMessage"><spring:message code="process.success" /></c:set>
            <c:set var="errorProcess"><spring:message code="process.error" /></c:set>
            <spring:url value="/covid/participants/{codigo}" var="participantsUrl">
                <spring:param name="codigo" value="${casoCovid19.codigoCaso}" />
            </spring:url>
            ...
            <div class="card-body bg-primary text-white mailbox-widget pb-0">
                <h2 class="text-white pb-3"><spring:message code="others" /> <spring:message code="covid19.positives" /></h2>
                            ...
                            <form name="frm_otros_positivos" id="frm_otros_positivos" class="mt-5" action="#" autocomplete="off">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="input-group col-md-10">
                                        ...
                                        <input type="text" class="form-control" id="idparticipante" name="idparticipante" value="${procesos.codigo}"  readonly>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="input-group col-md-10">
                                        ...
                                        <input type="text" class="form-control" id="estudio" name="estudio" readonly value="${procesos.estudio}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="input-group col-md-10">
                                        ...
                                        <input type="text" class="form-control" id="casaChf" name="casaChf" readonly value="${procesos.casaCHF}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <a href="${fn:escapeXml(participantsUrl)}" class="btn btn-warning btn-lg btn-ladda float-right" data-style="expand-right">
            ...
            $.post(parametro.saveOtrosCandidateTCovidUrl, form.serialize(), function( data ){
                ...
                if(registro.msj != null){
                    ...
                    window.setTimeout(function () {
                        window.location.href= parametro.participantsUrl;
                    }, 1500);
                }
            },'text' )
