                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select class="form-control" id="idversion" name="idversion" required="required">
                                            ...
                                            <c:forEach items="${version}" var="v">
                                                <option value="${v.idversion}">${v.version}</option>
                                            </c:forEach>
                                        </select>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="idversion">Parte:</label>
                                        <input type="text" class="form-control" id="parte" name="parte" required="required"/>
                                    </div>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        function ObtenerVersion(dir){
            ...
            $version.empty();
            $.getJSON(dir.GetVersionUrl, { idcarta : idcarta,   ajax : 'true'  }, function(data) {
                var len = data.length;
                if(len == 0){
            ...
            $.post(dir.saveParteUrl, formP.serialize(), function(data){
                if (data.msj != null) {
                    ...
                    window.setTimeout(function(){
                        window.location.href = dir.ListadoParteUrl;
                    }, 1500);
                }
